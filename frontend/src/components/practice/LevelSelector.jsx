...
const LEVELS = [
    {
        ...
        label: 'Pronunex Core',
        icon: Sparkles,
        description: <>(Beginner) <br /> Simple words & clear pronunciation</>,
    ...
    },
    {
        ...
        label: 'Pronunex Edge',
        icon: Zap,
        description: <>(Intermediate) <br />'Compound sentences & stress patterns'</>,
    ...
    },
    {
        ...
        icon: Trophy,
        description: <>(Advance) <br />'Complex prose, rhythm & elision'</>,
